...
const ConstructoHeader = () => {
    ...
    const whichTitle = () =>{
        ...
        return router.pathname.includes("create") ? "Volver" : "Crear proyecto"        
    }

    return (
        <nav className="flex items-center  flex-wrap bg-[var(--primary-color)]  rounded p-6 gap-2 m-2">
            ...
            <div className="flex lg:w-[80%] w-[50%] md:justify-center">
                <span className="text-white font-semibold  text-[30px] tracking-tight text-center">
                    {whichTitle()}
                </span>
            ...
            {
                user ? <a onClick={() => router.pathname.includes("create") ? router.push("/") : router.push("/create")}
                    className="inline-block text-sm px-2 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal hover:bg-white  ">
                    {router.pathname.includes("create") ? "Volver" : "Crear proyecto"}
                </a> : <></>
            }
...
export default ConstructoHeader