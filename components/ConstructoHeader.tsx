...
const ConstructoHeader = () => {
    ...
    return (
        <nav className="flex items-center md:justify-between flex-wrap bg-teal-400  rounded p-6 gap-2 m-2">
            ...
            <span className="text-white font-semibold  text-[30px] tracking-tight">
                 
                {
                    router.pathname.includes("create") ? "Crear proyecto" : "Lista de proyectos"
                }
            </span>
           
            <a onClick={() => router.pathname.includes("create")?router.push("/"):router.push("/create")}
